...
<div id="account-settings" class="settings-text">
	<h1 class="settings-header" style="margin: 31px 0px 14px;">Comuniquese con Nosotros</h1>
	<div class="settings-container">
		<h2>Soporte</h2>
		<table class="settings-table" cellspacing="0" cellpadding="0">
						<tbody><tr>
				<td class="settings-left">Telefono</td>
				<td class="settings-right">
					<span id="current-password">044-565435</span>
					<a href="#" class="settings-change">llamar</a>
				</td>
			</tr>
			<tr>
				<td class="settings-left">Correo electrónico:</td>
				<td class="settings-right">
					<span id="current-email">weebdo@soporte.com</span>
					<a href="#" class="settings-change" >enviar mail</a>
				</td>
			</tr>
			<tr>
				<td class="settings-left">Fax:</td>
				<td class="settings-right">
					<span id="current-fullname">0998 455879</span>
				</td>
			</tr>
		</tbody></table>
	</div>
